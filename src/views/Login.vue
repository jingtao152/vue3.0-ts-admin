  ...
  <div class="login">
    <div class="login-wrapper">
      ...
      <div class="box-card">
        ...
        <el-form class="form-card" ref="formRef" :model="form" :rules="rules" label-width="80px">
          ...
          <div class="three-login">
              ...
              <img @click="handleClick('tencent')" src="../assets/qq.svg" alt="" />
          </div>
        </el-form>
      </div>
    </div>
...
export default defineComponent({
  setup() {
    ...
    const {codeImg, form, rules, loginIn, formRef, codeRef} = loginPassEvent(store)
